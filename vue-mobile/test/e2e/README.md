...
Scenarios for **MailLoginFormMobileWebclient** (username + domain login).
...
npm run test:e2e-mobile -- --setup "MailLoginFormMobileWebclient iPhone13"
npm run test:e2e-mobile:ui -- --setup "MailLoginFormMobileWebclient iPhone13"

# from modules/CoreMobileWebclient/vue-mobile
npm run test:e2e -- --setup "MailLoginFormMobileWebclient iPhone13"
